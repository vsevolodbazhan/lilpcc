...
Syntax *greater_than_new(Syntax *left, Syntax *right)
{
    BinaryExpression *binary_syntax = malloc(sizeof(BinaryExpression));
    binary_syntax->binary_type = GREATER_THAN;
    binary_syntax->left = left;
    binary_syntax->right = right;
...
Syntax *greater_or_equal_new(Syntax *left, Syntax *right)
{
    BinaryExpression *binary_syntax = malloc(sizeof(BinaryExpression));
    binary_syntax->binary_type = GREATER_THAN_OR_EQUAL;
    binary_syntax->left = left;
    binary_syntax->right = right;
...
char *syntax_type_name(Syntax *syntax)
{
    ...
    else if (syntax->type == BINARY_OPERATOR)
    {
        ...
        else if (syntax->binary_expression->binary_type == GREATER_THAN)
        {
            return "GREATER THAN";
        }
